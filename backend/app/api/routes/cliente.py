...
from app.services.services_crud import get_all_clientes, get_cliente_by_id, create_cliente, update_cliente, delete_cliente
...
def view_cliente(cliente_id: int, db: Session = Depends(get_db)):
    try:
