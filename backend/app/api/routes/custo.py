...
from app.services.services_vendas import create_custo, get_all_custos, get_custo_by_id
...
def view_custo_route(id_custo: int, db: Session = Depends(get_db), current_user: User = Depends(get_read_user_admin)):
    try:
