...
const AddProduto = () => {
  ...
  const validateForm = () => {
    ...
    if (!produtoData.descricao_produto)
      newErrors.descricao_produto = "Descrição do Produto é obrigatório";
    if (!produtoData.preco || produtoData.preco <= 0)
      newErrors.preco = "Preço total inválido";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrors({
        form: error.message || "Erro ao adicionar o produto. Tente novamente.",
      });
    } finally {
      setLoading(false);
    }
                ...
                <Card.Body className="produto-card-body">
                  ...
                  <Form onSubmit={handleSubmit}>
                    <Row>
                      <Col md={6}>
                        <Form.Group
                          ...
                          controlId="nome_produto"
                        >
                          <Form.Label className="produto-form-label">
                            Nome
                          </Form.Label>
                          <Form.Control
                    ...
                    <div className="button-container">
                      <Button
                        className="produto-button-container"
                        variant="primary"
                        type="submit"
                        disabled={loading}
                      >
