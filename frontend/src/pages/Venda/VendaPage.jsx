...
const VendaPage = () => {
  ...
  const filteredVendas = vendas.filter((venda) => {
    const matchesTipoVenda = tipoVendaFilter
      ? venda.tipo_venda === tipoVendaFilter
      : true;
    const matchesTipoFaturamento = tipoFaturamentoFilter
      ? venda.tipo_faturamento === tipoFaturamentoFilter
      : true;
    const matchesTipoMoeda = tipoMoedaFilter
      ? venda.moeda === tipoMoedaFilter
      : true;
