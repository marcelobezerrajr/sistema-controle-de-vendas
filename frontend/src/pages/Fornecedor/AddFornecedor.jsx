...
const AddFornecedor = () => {
  ...
  const validateForm = () => {
    const newErrors = {};
    if (!fornecedorData.nome_fornecedor)
      newErrors.nome_fornecedor = "Nome do Forncedor é obrigatório";
    if (!fornecedorData.percentual_comissao)
      newErrors.percentual_comissao = "Percentual Comissão é obrigatório";
              ...
              <Card className="fornecedor-card">
                ...
                <Card.Body className="fornecedor-card-body">
                  ...
                  {success && (
                    <Alert
                      variant="success"
                      className="fornecedor-alert-success"
                    >
                      {success}
                    </Alert>
                  )}
                  <Form onSubmit={handleSubmit}>
                    <Row>
                      <Col md={6}>
                        <Form.Group
                          className="fornecedor-form-group"
                          controlId="nome_fornecedor"
                        >
                          <Form.Label className="fornecedor-form-label">
                            Nome
                          </Form.Label>
                          <Form.Control
                    ...
                    <div className="button-container">
                      <Button
                        className="fornecedor-button-container"
                        variant="primary"
                        type="submit"
                        disabled={loading}
                      >
