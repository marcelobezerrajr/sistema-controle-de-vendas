    ...
    <Suspense fallback={<div>Carregando...</div>}>
      <Routes>
        ...
        <Route element={<PrivateRoute />}>
          ...
          <Route
            exact
            path="/cliente/update/:id_cliente"
          ...
          <Route
            exact
            path="/parcela/update/:id_parcela"
            element={<UpdateParcela />}
          />
          ...
          <Route
            exact
            path="/venda-vendedor/create"
            element={<AddVendaVendedor />}
          />
          <Route
            exact
            path="/venda-vendedor/view/:id_venda/:id_vendedor"
            element={<ViewVendaVendedorPage />}
          />
